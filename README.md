...
```text
/crypto_portfolio/crypto-portfolio-card.js?v=7
```
...
4. Add a resource:
   ...
   ```text
   URL:  /crypto_portfolio/crypto-portfolio-card.js?v=7
...
```text
https://your-home-assistant-url/crypto_portfolio/crypto-portfolio-card.js?v=7
```
